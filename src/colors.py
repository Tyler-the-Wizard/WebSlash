...
def load_palette(palette_index):
    if palette_index >= len(palettes):
        print('WARNING: Tried to load palette',
              palette_index,
              'but only',
              len(palettes),
              'exist! Skipping...')
...
palettes = [
   ...
   [pygame.Color( 29,  36,  42), # C_BG
    ...
    # 1 - ancient palette
   [pygame.Color( 42,  35,  29), # C_BG
    pygame.Color(255, 252, 243), # C_FG
    pygame.Color(235,  78,  91), # C_RED
    pygame.Color(246, 214, 140), # C_YELLOW
    pygame.Color(133, 242, 116), # C_GREEN
    pygame.Color(116, 116, 240), # C_BLUE
    ...
    pygame.Color(105,  97,  88), # C_GRAY
    pygame.Color(192, 188, 178), # C_LIGHT_GRAY
    pygame.Color(249, 197, 227), # C_PINK
    pygame.Color(240, 171,  99), # C_ORANGE
    pygame.Color(198, 249, 144), # C_LIGHT_GREEN
    pygame.Color( 17,  17, 193), # C_DEEP_BLUE
